        ...
        <div className="dash_sidebar">
          <ul className="d-flex flex-row flex-lg-column gap-1 gap-sm-2 gap-md-3 gap-lg-4 m-0 p-0 ">
            ...
            >
             ...
             <Link
              to="/contacted-hosts"
              className={currentPath === "/contacted-hosts" ? "active" : ""}
            >
              <li>
                <i className="fa-solid fa-phone me-1"></i> Contacted Hosts
              </li>
            </Link>

            <Link
              to="/booked-tours"
              className={currentPath === "/booked-tours" ? "active" : ""}
            >
              <li>
                <i className="fa-solid fa-house-circle-check me-1"></i> Booked Tours
              </li>
            </Link>

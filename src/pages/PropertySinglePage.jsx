...
const listingsData = {
    id: 1,
    title: "Near UMBC! Female only!",
    university: "4207 Maryland Pl, Baltimore, MD 21229",
    beds: 4,
    baths: 3,
    area:1350,
    distance: "0.6 mi",
                ...
                <div className="row g-4">
                    ...
                    <div className="card mb-4">
                        <div className="card-body">
                            ...
                            <button
                                className={`save-btn ${
                                    savedListings[listingsData.id] ? "active" : ""
                                }`}
                                onClick={(e) => {
                                    e.preventDefault();
                                    toggleSave(listingsData.id);
                                }}
                                >
                                <Heart
                                    size={18}
                                    fill={
                                    savedListings[listingsData.id]
                                        ? "var(--blue)"
                                        : "none"
                                    }
                                    stroke={
                        ...
                        person to share a large open concept newly renovated 4 bedroom and 3
